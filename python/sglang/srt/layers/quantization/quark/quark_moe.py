...
class QuarkW8A8FP8MoEMethod(QuarkMoEMethod):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        if _is_fp8_fnuz:
            # ALIGNED WITH COMPRESSOR: remove _QUARK_SKIP_FNUZ_NORMALIZE branch
        ...
        # ALIGNED WITH COMPRESSOR: add last dimension for per_channel scales
        ...
        # ALIGNED WITH COMPRESSOR: aiter shuffle with padding
        if _use_aiter:
